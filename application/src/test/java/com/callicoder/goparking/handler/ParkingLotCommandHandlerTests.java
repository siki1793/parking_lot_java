...
public class ParkingLotCommandHandlerTests {
    ...
    public void testCreateParkingLotOutput() {
        ...
        assertEquals(String.format(PARKING_LOT_CREATED_MSG, 10) + System.lineSeparator(), outContent.toString());
    }
    ...
    public void testCreateMultipleParkingLotOutput() {
        ...
        assertTrue(outContent.toString().endsWith(PARKING_LOT_ALREADY_CREATED + System.lineSeparator()));
    }
    ...
    public void testParkOutput() {
        ...
        assertTrue(outContent.toString().endsWith("Allocated slot number: 1"+System.lineSeparator()));
        assertEquals(String.format(PARKING_LOT_CREATED_MSG, 6) + System.lineSeparator()+
                String.format(PARKING_SLOT_ALLOCATED_MSG, 1) + System.lineSeparator(), outContent.toString());
    }
    ...
    public void testParkWithNoParkingLotOutput() {
        ...
        assertTrue(outContent.toString().endsWith(PARKING_LOT_NOT_CREATED + System.lineSeparator()));
    }
    ...
    public void testParkDuplicateVehicle() {
        ...
        assertTrue(outContent.toString().endsWith(DUPLICATE_VEHICLE_MESSAGE+System.lineSeparator()));
    }
    @AfterAll
